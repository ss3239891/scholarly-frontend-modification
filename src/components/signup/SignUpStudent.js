...
export class SignUpStudent extends React.Component {
  ...
  componentWillMount(){
    if(window.localStorage.getItem("scholarlyscience.in-activation")){
      var readls = JSON.parse(window.localStorage.getItem("scholarlyscience.in-activation"))
    ...
    return (
      <div className="main">
        ...
        <div className="container">
          <div className="signup-title">Sign up for xyz</div>
          ...
          <div className="log-in">
            ...
            <span className="log-in-link">Sign in</span>
          </div>
        </div>
